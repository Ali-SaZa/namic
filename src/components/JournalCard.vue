<template>
  <div class="p-4 bg-base rounded-lg" :class="item.hasRegistered?'border-r-3 border-green-500':''">
      ...
      <div class="flex items-center flex-col mt-4">
        ...
        <template v-if="item.priceType === 1">
          ...
          <div class="flex items-center justify-between w-full text-sm mt-2">
            ...
            <div>مبلغ سند :
              <span v-format-number="item.fi/(4.3318 * item.weight)">
            </span>
            </div>
          </div>
          <div class="w-full">
    ...
    >
      <div>
        <span v-if="item.hasRegistered">
          این سند قبلا چاپ شده است،
        </span>
